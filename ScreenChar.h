...
typedef struct screen_char_t
{
    ...
    //   foregroundColor contains red in its high 6 bits and the high 2 bits of green.
    //   fgGreen contains the low 4 bits of green. fgBlue contains all 6 bits of blue.
